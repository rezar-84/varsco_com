...
import heroTrials from "@/assets/aegean-region-klcdeniz-hatchery-trials-2.webp";
...
function Projects() {
  ...
  return (
    <div className="bg-background min-h-screen pb-20">
      ...
      <section className="bg-navy text-white relative isolate overflow-hidden py-16 lg:py-20 border-b border-border/80">
        <img
          src={heroTrials}
      ...
      {/* Case studies band. Each main section now owns a full-bleed background
          instead of everything sharing one container on bg-background — the
          bands are what separate filter/grid, methodology and CTA visually. */}
                      ...
                      <div className="grid grid-cols-3 gap-3">
                        {project.metrics.map((m) => (
                          ...
                          >
                            ...
                            <div className="text-[10px] text-navy/70 font-bold mt-0.5">
                              {m.label}
                            </div>
                          </div>
                        ))}
      ...
      {/* Methodology band — shaded, so it reads as a different kind of content
          from the case-study cards above it. */}
      <div className="bg-surface-alt border-y border-border/60">
      ...
      <div className="bg-background">
        ...
        */}
          ...
          <section className="rounded-3xl p-8 sm:p-12 border border-white/20 bg-gradient-to-br from-navy via-slate-900 to-navy text-white shadow-2xl relative overflow-hidden text-center space-y-6">
